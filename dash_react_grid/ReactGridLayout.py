...
class ReactGridLayout(Component):
...
- cols (number | dict with strings as keys and values of type number; default 12):
    Number of columns in the grid or per breakpoint when using
    responsive layouts.
...
- layout (list of dicts; optional):
    Layout configuration for the grid. Each entry must include `i`,
    `x`, `y`, `w`, `h`.
...
- useCSSTransforms (boolean; default True):
    ...
    def __init__(
        ...
        cols: typing.Optional[typing.Union[NumberType, typing.Dict[typing.Union[str, float, int], NumberType]]] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'allowOverlap', 'autoSize', 'breakpoints', 'className', 'cols', 'compactType', 'containerPadding', 'draggableCancel', 'draggableHandle', 'isDraggable', 'isResizable', 'layout', 'layouts', 'margin', 'maxRows', 'preventCollision', 'responsive', 'rowHeight', 'style', 'useCSSTransforms']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'allowOverlap', 'autoSize', 'breakpoints', 'className', 'cols', 'compactType', 'containerPadding', 'draggableCancel', 'draggableHandle', 'isDraggable', 'isResizable', 'layout', 'layouts', 'margin', 'maxRows', 'preventCollision', 'responsive', 'rowHeight', 'style', 'useCSSTransforms']
        ...
        super(ReactGridLayout, self).__init__(children=children, **args)

setattr(ReactGridLayout, "__init__", _explicitize_args(ReactGridLayout.__init__))
